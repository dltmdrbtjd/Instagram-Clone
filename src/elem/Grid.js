...
const Grid = (props) => {
    const { display,jContent,bordertop,borderbot,cover,pc,bgColor,index, left,top,radius, height, position, children, width, padding, margin, center, is_flex, border, cursor, _onClick, bg} = props;
